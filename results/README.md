...
Run, on 2026-08-09; see `text_ladder_gptoss` above. `../FINDINGS.md` predates
that run and still describes text as not run; the top section here and the paper
kit in `../README.md` supersede it.
