...
6. Publish. The DOI activates and the record becomes permanent, and Zenodo records
...
on redistributing model outputs, check it before publishing, because Zenodo records are
permanent.
